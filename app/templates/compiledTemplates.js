...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<h1> Court </h1>\n\n<p>What the!</p>\n<p>"
    + escapeExpression(((stack1 = ((stack1 = depth0.model),stack1 == null || stack1 === false ? stack1 : stack1.courtname)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "<p>\n<p>What the!</p>\n<p>";
  if (stack2 = helpers.courtname) { stack2 = stack2.call(depth0, {hash:{},data:data}); }
  else { stack2 = depth0.courtname; stack2 = typeof stack2 === functionType ? stack2.apply(depth0) : stack2; }
